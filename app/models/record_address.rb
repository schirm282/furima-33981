class RecordAddress
  ...
  def save
    ...
    Address.create(postal_code: postal_code, delivery_source_area_id: delivery_source_area_id, municipality: municipality, house_number: house_number, building: building, phone_number: phone_number, user_id: user_id, record_id: record.id)
  end
end